...
class ResNet(nn.Module):
    ...
    def forward(self, x, is_feat=False, preact=False):
        ...
        # x = self.linear1(x)
        # x = self.Hardswish(x)
        x = MC_dropout(x, p=0.2 ,mask=True)
        # x = self.relu(x)
...
if __name__ == '__main__':
    ...
    net = mcdo_resnet8x4(num_classes=20)
