...
class ResNet(nn.Module):
    ...
    def _forward_impl(self, x):
        ...
        x = MC_dropout(flatten, p=0.2 ,mask=True)
        x = self.fc(flatten)
...
def mcdo_resnet18(pretrained=False, progress=True,  **kwargs):
...
def mcdo_resnet34(pretrained=False, progress=True,  **kwargs):
...
def mcdo_resnet50(pretrained=False, progress=True,  **kwargs):
...
def mcdo_resnet101(pretrained=False, progress=True,  **kwargs):
...
def mcdo_resnet152(pretrained=False, progress=True,  **kwargs):
